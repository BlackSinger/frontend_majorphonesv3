...
import {
    ...
    handleCancelEmptySimUK,
    handleActivateEmptySim,
    handleActivateEmptySimUK
} from './EmptySimLogicTest';
    ...
    const handleActionClick = async (action: string, record: HistoryRecord) => {
        ...
        if (action === 'Cancel') {
            if (record.serviceType === 'Short') {
                ...
                if (record.country.toLowerCase() === 'usa') {
                    await handleCancelEmptySim(record.id, record.orderId || '', setErrorMessage, setShowErrorModal, setCancellingOrderId);
                } else if (record.country.toLowerCase() === 'uk') {
                    await handleCancelEmptySimUK(record.id, record.orderId || '', setErrorMessage, setShowErrorModal, setCancellingOrderId);
                }
        ...
        if (action === 'Activate') {
            if (record.serviceType === 'Middle') {
                ...
                if (record.country.toLowerCase() === 'usa') {
                    ...
                    await handleActivateEmptySimUK(record.id, record.orderId || '', setErrorMessage, setShowErrorModal, setActivatingOrderId);
                }
            }
            return;
        }
