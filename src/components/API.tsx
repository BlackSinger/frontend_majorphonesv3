...
const API: React.FC = () => {
          ...
          <div className="mb-6">
            <div className="flex space-x-4 border-b border-slate-700/50">
              <button
                ...
                className={`pb-3 px-1 text-md font-semibold transition-all duration-300 border-b-2 ${activeTab === 'keys'
              ...
              <button
                ...
                className={`pb-3 px-1 text-md font-semibold transition-all duration-300 border-b-2 ${activeTab === 'docs'
                  ? 'text-emerald-400 border-emerald-400'
                  : 'text-slate-400 border-transparent hover:text-slate-300'
                  }`}
              >
  ...
  -H "apikey: your-api-key-here"`}
                  ...
                  <div>
                    ...
                    <pre className="bg-slate-900 p-3 sm:p-4 rounded-xl overflow-x-auto text-left">
                      <code className="text-xs sm:text-sm text-slate-300">
                        {`fetch('https://api.majorphones.com/v1/user/verify', {
  method: 'POST',
  headers: {
...
.then(data => console.log(data));`}
                    ...
                    <div>
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="border-l-4 border-blue-500 pl-3 sm:pl-4">
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            <span className="px-2 py-1 bg-blue-500/20 text-blue-400 rounded text-xs font-semibold">POST</span>
                            <code className="text-slate-300 text-xs sm:text-sm break-all">/sms/send</code>
                          </div>
                          <p className="text-slate-400 text-xs sm:text-sm mb-2">Send SMS to a number worldwide</p>
                          <div className="bg-slate-900/50 p-2 sm:p-3 rounded-lg">
                            <p className="text-xs text-slate-400 mb-1">Request Body:</p>
                            <pre className="text-xs text-slate-300 overflow-x-auto text-left">
                              <code>{`{
  "numbers": array of strings // Array of numbers to send SMS to,
  "countries": array of strings // Array of countries to send SMS to,
  ...
  "carrier": string // Only works with option 1 (e.g., "at&t", "tmobile")
                          ...
                          <div className="border-l-4 border-green-500 pl-3 sm:pl-4">
                            <div className="flex flex-wrap items-center gap-2 mb-1">
                              <span className="px-2 py-1 bg-green-500/20 text-green-400 rounded text-xs font-semibold">POST</span>
                              <code className="text-slate-300 text-xs sm:text-sm break-all">/sms/short/reuse</code>
                            </div>
                            <p className="text-slate-400 text-xs sm:text-sm mb-2">Reuse a short-term SMS number</p>
                            <div className="bg-slate-900/50 p-2 sm:p-3 rounded-lg">
                              <p className="text-xs text-slate-400 mb-1">Request Body:</p>
                              <pre className="text-xs text-slate-300 overflow-x-auto text-left">
                                <code>{`{
  "orderId": string // Order ID of the number you want to reuse (not all short numbers can be reused)
}`}</code>
                              </pre>
                            </div>
                          </div>
