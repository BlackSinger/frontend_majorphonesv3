...
const LongTerm: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // Mock data with fixed 30-day duration
    ...
    <DashboardLayout currentPath="/long">
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl shadow-2xl border border-slate-700/50 p-8 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 via-indigo-600/5 to-blue-600/10"></div>
          <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-400/20 to-indigo-500/20 rounded-full blur-3xl animate-pulse"></div>
          ...
          <div className="relative z-10">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-300 text-lg">Extended 30-day validity numbers</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl shadow-2xl border border-slate-700/50 relative overflow-hidden">
          {/* Background Effects */}
          <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 via-indigo-600/5 to-blue-600/10"></div>
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-purple-400/20 to-indigo-500/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-blue-400/15 to-purple-400/15 rounded-full blur-2xl animate-pulse delay-1000"></div>
            ...
            <div className="p-10">
              <div className="relative z-10 max-w-5xl mx-auto">
                ...
                <div className="text-center mb-12">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-2xl mb-6 shadow-xl">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                  </div>
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-purple-100 to-indigo-100 bg-clip-text text-transparent mb-3">
                    Search & Configure
                  </h2>
                  <p className="text-slate-300 text-lg">Find long-term numbers with 30-day validity</p>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="max-w-lg mx-auto">
                    <div className="space-y-3">
                      <label className="block text-sm font-semibold text-purple-300 uppercase tracking-wider text-center">
                        Search Services
                      </label>
                      <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                          <svg className="h-6 w-6 text-purple-400 group-focus-within:text-purple-300 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                          </svg>
                        </div>
                        <input
                          ...
                          className="w-full pl-14 pr-6 py-5 bg-slate-800/50 border-2 border-slate-600/50 rounded-2xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500/50 transition-all duration-300 backdrop-blur-sm text-lg shadow-inner hover:border-slate-500/50"
                  ...
                  {/* Duration and Country Information */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Duration Information */}
                    <div className="flex justify-center">
                      <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-6 border border-slate-600/30 hover:border-purple-500/30 transition-all duration-300 shadow-lg w-full">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-slate-400 text-sm mt-1">All numbers valid for 30 days</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                      <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-6 border border-slate-600/30 hover:border-purple-500/30 transition-all duration-300 shadow-lg w-full">
                        <div className="flex items-center space-x-4">
                          <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center text-2xl shadow-lg">
                            🇺🇸
                          </div>
                          <div>
                            <span className="text-white font-semibold text-lg">United States Only</span>
                            <p className="text-slate-400 text-sm mt-1">All numbers from United States</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="text-center pt-4">
                    <button 
                      ...
                      className="group px-12 py-5 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 hover:from-purple-500 hover:via-indigo-500 hover:to-blue-500 text-white font-bold text-xl rounded-2xl transition-all duration-300 shadow-2xl hover:shadow-purple-500/25 hover:scale-105 border border-purple-500/30 hover:border-purple-400/50 relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                    >
            ...
            <div className="p-8">
              <div className="relative z-10">
                ...
                <div className="text-center mb-10">
                  ...
                  <h3 className="text-3xl font-bold bg-gradient-to-r from-white via-purple-100 to-indigo-100 bg-clip-text text-transparent mb-3">
                    Available Numbers
                  </h3>
                ...
                {searchResults.length > 0 ? (
                  <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                    {searchResults.map((option) => (
                      <div
                        key={option.id}
                        className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-600/50 hover:border-purple-500/50 transition-all duration-300 shadow-lg hover:shadow-purple-500/25 hover:scale-[1.02]"
                      >
                        {/* Number Header */}
                        <div className="flex items-center justify-between mb-6">
                          <div className="flex items-center space-x-3">
                            <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center text-xl">
                        ...
                        <div className="space-y-4 mb-6">
                          ...
                          <div className="flex items-center justify-between py-2">
                            ...
                            <span className="text-purple-400 font-semibold bg-purple-500/10 px-3 py-1 rounded-lg">
                              {option.service}
                            </span>
                          </div>
                        </div>
                        ...
                        {/* Purchase Button */}
                        <button className="w-full py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-purple-500/25 hover:scale-[1.02]">
                          Purchase Number
                        </button>
                      </div>
                    ))}
