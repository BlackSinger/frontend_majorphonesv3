...
const EmptySimcardTest: React.FC = () => {
    ...
    const handlePurchase = async (option: NumberOption) => {
        ...
        try {
            ...
            let endpoint = 'https://buyemptysimcardusa-ezeznlhr5a-uc.a.run.app';
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-emerald-500/10 via-green-500/5 to-emerald-500/10 border border-emerald-500/30 rounded-2xl px-4 py-3 mb-6">
                <p className="text-center text-sm">
                    ...
                    <span className="text-slate-200">Now you can purchase empty SIM cards from <span className="text-emerald-400 font-semibold">United Kingdom</span>, scroll down the country selector to see it!</span>
                </p>
            </div>
                                        ...
                                        {searchResults.length > 0
                                            ? (
                                                <span className="flex items-center flex-wrap">
                                                    Found {searchResults.length} {searchResults.length === 1 ? 'number' : 'numbers'} from {selectedCountry}
                                                ...
                                                <div className="flex items-center justify-between mb-4">
                                                    <div className="flex items-center space-x-2">
                                                        <div className="w-9 h-9 bg-blue-300/10 rounded-xl flex items-center justify-center">
                                                            <span className="text-emerald-400 font-bold text-sm">{['1st', '2nd', '3rd'][index] || `${index + 1}th`}</span>
                                                        </div>
                                                        <div>
...
export default EmptySimcardTest;