                      ...
                      <tbody>
                        {paginatedData.map((record, index) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-6">
                              <span className={`inline-block px-3 py-2 rounded-xl text-sm font-semibold border w-24 text-center ${record.status === 'open'
              ...
              <div className="space-y-3">
                ...
                <div className="relative group" ref={issueTypeDropdownRef}>
                  <div
                    ...
                    className={`w-full px-4 py-3 bg-slate-800/50 border-2 border-slate-600/50 rounded-2xl text-white text-sm shadow-inner focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500/50 transition-all duration-300 flex items-center justify-between ${isCreatingTicket
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      className={`border-2 border-dashed rounded-2xl p-6 text-center bg-slate-800/30 transition-all duration-300 ${isCreatingTicket
                        ? 'opacity-50 cursor-not-allowed'
                        : isDragOver
            ...
            <div className="relative z-10">
              ...
              <div className="text-left mb-7">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`inline-block px-3 py-2 rounded-xl text-sm font-semibold border ${selectedTicket.status === 'open'
                    ? 'text-green-400 border-green-500/30'
                    : 'text-red-400 border-red-500/30'
                    }`}>
                  ...
                  <div className="flex-1 overflow-y-auto mb-4 space-y-3 px-3">
                    ...
                    {selectedTicket.response && selectedTicket.response.length > 0 && selectedTicket.response.map((response, index) => (
                      <div key={`response-${index}`} className={`flex ${response.isUser ? 'justify-end' : 'justify-start'}`}>
                        <div className={`relative rounded-lg px-4 py-2 max-w-[85%] sm:max-w-sm md:max-w-md ${response.isUser
                          ? 'bg-emerald-600/80'
                          : 'bg-slate-700/50'
                          }`}>
                          {response.message && (
                            ...
                            <div className="mt-2 space-y-1">
                              ...
                              {response.images.map((image, imgIndex) => (
                                <div
                                  ...
                                  className={`flex items-center space-x-2 rounded px-2 py-1 cursor-pointer hover:opacity-80 transition-opacity ${response.isUser ? 'bg-emerald-700/30' : 'bg-slate-600/30'
                                    }`}
                                >
