...
// Calculate duration for Empty SIM cards
...
export const handleCancelEmptySim = async (
  ...
  try {
    ...
    console.error('Cancel Empty SIM card error:', error);
...
// Handle activate Empty SIM card
export const handleActivateEmptySim = async (
  ...
  try {
    ...
    console.error('Activate Empty SIM card error:', error);
    setErrorMessage('Please contact our customer support');
    setShowErrorModal(true);
    setActivatingOrderId(null);
  }
