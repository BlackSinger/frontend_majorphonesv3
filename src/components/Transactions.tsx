...
interface TransactionRecord {
  id: string;
  option: 'Cryptomus' | 'Amazon Pay' | 'Admin Update' | 'USDT Tether' | 'USDC' | 'Matic' | 'Tron' | 'Alipay (China)' | 'PayNow (Singapore)' | 'VietQR (Vietnam)' | 'Credit Card (South Africa)' | 'Bank Card (Nigeria)' | 'Bank Transfer (Nigeria)' | 'Airtel Money (Kenya)' | 'MTN Mobile Money (Rwanda)' | 'Airtel Money (Rwanda)' | 'Tigo Pesa (Tanzania)' | 'MTN Mobile Money (Uganda)' | 'Airtel Money (Uganda)' | 'Credit Card (South Korea)' | 'PAYCO (South Korea)' | 'Samsung Pay (South Korea)' | 'KakaoPay (South Korea)';
  date: string;
