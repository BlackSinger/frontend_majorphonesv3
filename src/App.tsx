...
import EmptySimcardTest from './components/EmptySimcardTest';
      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            <Route path="/test" element={<PrivateRoute><DashboardLayout><EmptySimcardTest /></DashboardLayout></PrivateRoute>} />
